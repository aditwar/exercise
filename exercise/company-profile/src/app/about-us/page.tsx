        ...
        <>
            <section className='w-full pt-[180px]'>
                <div className='max-w-7xl mx-auto px-10 flex flex-col items-center'>
                    <h1 className='tracking-[2px] text-black font-bold w-[400px] lg:w-[700px] text-2xl lg:text-4xl text-center mb-10'>The main location is in Dallas-USA and there are other nodes in other countries/continents to verify down statuses.</h1>
             ...
             <section className="w-full bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500">
                <div className="max-w-7xl mx-auto flex flex-col">
                    <div className='m-10'>
                        <h1 className="text-white text-3xl mx-auto text-center font-semibold pb-5 lg:text-5xl lg:w-[700px]">Innovating to Address global health challenges</h1>
                        <p className="text-gray-200 text-center mx-auto pb-5 lg:w-[800px]">
                            We have a proud heritage of ground-breaking innovation that stretches back over 130 years. Meaningful innovation focused on our customers needs remains at the heart of everything we do.</p>
                    </div>
                    <div className="flex flex-wrap justify-center mx-auto gap-3.5 lg:gap-5 pb-20">
                        <div className=" w-[180px] h-[200px] lg:w-[360px] lg:h-[250px] lg:p-8 flex flex-col justify-center bg-[#ffffff40] bg-opacity-25 p-2 rounded-lg text-white">
                            <h1 className="text-4xl lg:text-5xl pb-2 font-bold">#1<span className="text-2xl lg:text-3xl"> Best Company</span></h1>
