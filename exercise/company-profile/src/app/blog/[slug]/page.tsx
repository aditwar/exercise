  ...
  return (
    <Wrapper>
      <div className="flex pt-[150px]">
        <div className="flex-1 max-md:hidden top-[100px] h-full">
        ...
        <div className="flex-[2] pr-52 max-lg:pr-0 text-black">
          <h5 className="mb-2 text-[32px] max-md:text-[24px] font-bold tracking-tight text-black">
            {blog.fields.title}
          </h5>
